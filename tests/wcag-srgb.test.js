...
test("#8", () => {
  ...
  assert.is(
    ...
    "oklch(67.77043552404355% 0.1 50)"
  );
...
test("#12", () => {
  ...
  assert.is(
    ...
    "oklch(49.60536761524015% 0.14 300)"
  );
...
test("#13", () => {
  ...
  assert.is(
    ...
    "oklch(80.7036473155256% 0.18 120)"
  );
...
test("#24", () => {
  ...
  assert.is(
    ...
    "oklch(55.468749637985745% 0.09375000000000001 200)"
  );
...
test("#26", () => {
  ...
  assert.is(
    ...
    "oklch(21.602329772099985% 0.11250000000000003 300)"
  );
